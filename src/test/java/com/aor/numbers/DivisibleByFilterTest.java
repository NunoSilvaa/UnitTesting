...
public class DivisibleByFilterTest {
    ...
    void acceptDivideBy2() {
        ...
        List<Integer> divisible = Arrays.asList(0, 2, 4, 8, 100, 1000, 10000);
        List<Integer> notDivisible = Arrays.asList(1, 3, 5, 13, 741, 10007);
    ...
    void acceptDivideBy3() {
        ...
        List<Integer> divisible = Arrays.asList(0, 3, 6, 9, 33, 999, 6666);
